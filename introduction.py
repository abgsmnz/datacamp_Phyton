...
Our friends at the police station have acquired cell phone data, which gives some of Freddie's locations over the past three weeks. 
It's stored in the DataFrame cellphone. The x-coordinates are in the column 'x' and the y-coordinates are in the column 'y'.
...
"""
#Part1: Change the color of the points to 'red'.
...
#Part2: Change the marker shape to square.
...
#Part3: Change the transparency of the scatterplot to 0.1.
...
"""
#Part1: Display the DataFrame hours using a print command.
# Display the DataFrame hours using print
print(hours.head())

#Part2: Create a bar chart of the column avg_hours_worked for each officer from the DataFrame hours.
# Display the DataFrame hours using print
print(hours)
...
#Part3: Use the column std_hours_worked (the standard deviation of the hours worked) to add error bars to the bar chart.
# Display the DataFrame hours using print
print(hours)
...
"""
#Part1: Create a bar plot of the time each officer spends on desk_work.
...
#Part2: Create a bar plot for field_work whose bottom is the height of desk_work.
...
"""
#Part1: Create a histogram of the column weight from the DataFrame puppies.
...
#Part2: Change the number of bins to 50.
...
#Part3: Change the range to start at 5 and end at 35.
...
"""
#Part1: Create a histogram of gravel.radius.
...
#Part2: Modify the histogram such that the histogram is divided into 40 bins and the range is from 2 to 8.
# Create a histogram
...
#Part3: Normalize your histogram so that the sum of the bins adds to 1.
# Create a histogram
# Normalize to 1
plt.hist(gravel.radius,
         bins=40,
...
#Part4: Label the x-axis (Gravel Radius (mm)), the y-axis (Frequency), and add the title (Sample from Shoeprint).
# Create a histogram
plt.hist(gravel.radius,
         bins=40,
         range=(2, 8),
